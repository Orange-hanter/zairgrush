...
def main():
    ...
    print(f"\n  ИТОГ по спеке: A {100 * aa / ak if ak else 0:.0f} % против "
          ...
          f"{100 * b_n / b_tot if b_tot else 0:.0f} %).")
    print("  Упали обе, но по-разному: A на 40 %, B больше чем вдвое. "
          "Сырая\n  выживаемость меряла не только тесты, но и молчание "
          "спецификации\n  с щедростью генератора мутантов — и у плеча, "
          "писавшего тесты по\n  своей же реализации, ложных дыр "
          "оказалось больше.")
    return 0
