...
**Статус: решено владельцем 2026-09-15 (NXT-026)** — по рекомендации
брифа: пороги подтверждены как есть, «вмешательства человека» считается
по установившимся прогонам, три строки без замера действуют как цель до
выгрузки из журнала пилота. Пометка «проект значений» снята с §9.1
(05 v0.62), каждая строка получила способ проверки. Одновременно приняты
бюджетные правила волн (пул $60, политика отказов) — записаны в
08-operators-guide.md, «Бюджет волны».
...
**Статус: решено владельцем 2026-09-15 (NXT-026)** — по рекомендации
брифа: подтверждено без изменений. Пометка «на утверждение» снята с §12
(05 v0.62); единая таксономия всех поверхностей находок (вердикт,
findings.jsonl, панель/адъюдикатор, goldset) записана в
13-findings-taxonomy.md (WAV-009) со ссылками из 05 §12 и 09 §5.
...
- Брифы 2 (C2) и 3 (C3) получили статус «решено владельцем 2026-09-15
  (NXT-026)»: пороги §9.1 подтверждены (снятие «проекта значений», способ
  проверки каждой строки — 05 v0.62), таксономия §12 подтверждена без
  изменений, единая таксономия находок — 13-findings-taxonomy.md.
  Брифы 1 и 4 остаются в прежнем статусе.
