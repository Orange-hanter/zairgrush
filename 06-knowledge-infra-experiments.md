...
- **Статус: отложен** до появления реального потребителя поиска
  (суммаризатор «что пробовали», §7.2). Не открывать, пока E1 не даст
  jsonl-журнал. Прогноз: A.
...
канарейки c5/c6), E2/E5/E7 — в очереди; E6 отложен.
