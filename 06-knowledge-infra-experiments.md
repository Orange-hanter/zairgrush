...
- **Стоимость**: ≤3 прогонов ревьюера (правило §1); исполнитель не
  ...
  программы.
- **Статус: open.** Задачи исполнения живут в cod-doc (план
...
гигиеной линтера, а не памятью. Плечо ревьюера прогона ещё ждёт; **E15 открыт
(2026-09-12)**: вопрос «одно семейство у исполнителя и ревьюера» вынесен из
caveat E13 в собственный замер — парный пересуд канареек и frozen diffs без
запуска исполнителя, задачи в cod-doc плане `experiment-e15`; **E12 — оба реплей-стенда
